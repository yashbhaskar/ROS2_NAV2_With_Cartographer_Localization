...
def generate_launch_description():
    ...
    bridge_node = Node(
        ...
        arguments=[
            ...
            # '/odom@nav_msgs/msg/Odometry[ignition.msgs.Odometry',     # diff drive odom
    ...
    gazebo_odom=Node(
        ...
        name="odom_bridge",
        output="screen",
        arguments=['/model/ros2_bot/odometry@nav_msgs/msg/Odometry[ignition.msgs.Odometry'],
        remappings=[('/model/ros2_bot/odometry','/odom')]                 # Gazebo Odometry
    )
