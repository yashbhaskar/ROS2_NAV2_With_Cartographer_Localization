...
options = {
  ...
  submap_publish_period_sec = 0.5,  -- submap release cycle (seconds)
  pose_publish_period_sec = 0.1,  -- attitude release period (seconds)
  trajectory_publish_period_sec = 0.3,  -- trajectory release period (seconds)
...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 20  -- Number of range data for submaps in the 2D track builder  
...
TRAJECTORY_BUILDER_2D.missing_data_ray_length = 3.5  --5 Restricted to maximum LiDAR scanning range  
